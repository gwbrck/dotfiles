...
(defun vulpea-agenda-files-update (&rest _)
  ...
  (add-to-list 'org-agenda-files (concat org-roam-directory "archiv.org"))
...
(advice-add 'org-caldav-sync :before #'vulpea-agenda-files-update)
...
(provide 'vulpea-org-roam-caldav)
